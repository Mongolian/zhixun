...
public class NewsContentProvider extends ContentProvider {
	...
	public static final String TEMPLATES_TYPE = "vnd.android.cursor.dir/news";
	public static final String TEMPLATES_ITEM_TYPE = "vnd.android.cursor.item/news";

	private NewsSqliteHelper mDbHelper;

	static final UriMatcher matcher = new UriMatcher(UriMatcher.NO_MATCH);
	static {
		matcher.addURI(AUTHORITY, null, ALL_NEWS);
		matcher.addURI(AUTHORITY, "/#", SINGLE_NEWS);
	}
