...
public final class ResGetNewsContent extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    {
        return "zhi_xun.ResGetNewsContent";
    }
    ...
    public zhi_xun.ClientNewsContent content = null;
    ...
    public zhi_xun.ClientNewsContent getContent()
    {
        return content;
    }

    public void  setContent(zhi_xun.ClientNewsContent content)
    {
    ...
    public ResGetNewsContent(int code, zhi_xun.ClientNewsContent content)
    {
        this.code = code;
        this.content = content;
    }
    ...
    static zhi_xun.ClientNewsContent cache_content;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        ...
        {
            cache_content = new zhi_xun.ClientNewsContent();
        }
        this.content = (zhi_xun.ClientNewsContent) _is.read(cache_content, 1, true);
    }
